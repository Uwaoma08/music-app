...
const AllSongsMobile = ({img, onClick}) => {
  return (
    <div onClick={onClick} className="h-56px bg-[#25282c] hover:bg-[#444c57] text-white flex flex-row items-center p-3 rounded-lg w-full lg:hidden md:hidden block mb-4">
